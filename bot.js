...
client.on('ready', () => {
    ...
    client.user.setPresence({status: 'online', game: {name: 'keeping it real (grim)'}});
    halloffame.Init();
    stash.Init();
    feed.Init(client);
    streams.Init(client);
...
client.on('message', msg => {
    ...
    if (lowercaseContent === ".help") {
        ...
        msg.channel.send("I've been livin' for " + Math.round(moment.duration(client.uptime).asMinutes()) + " minute(s).");
    }
